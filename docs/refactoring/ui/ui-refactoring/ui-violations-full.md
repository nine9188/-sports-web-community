...
**→ 상세 목록: [dark-mode-violations.md](./dark-mode-violations.md)**
...
**→ 상세 목록: [light-mode-violations.md](./light-mode-violations.md)**
...
**→ 상세 목록: [button-color-violations.md](./button-color-violations.md)**
...
**→ 상세 목록: [border-color-violations.md](./border-color-violations.md)**
...
**→ 상세 목록: [rounded-violations.md](./rounded-violations.md)**
...
| 파일 | 이유 |
|------|------|
| layout.tsx | CSS 변수 정의용 |
| UIThemeSettingsPage.tsx | Admin 테마 설정 |
| PostContent.tsx | 위반 없음 (오탐) |

---

## 7. 텍스트 색상 위반 (4개 파일, 12곳)

> ❌ `dark:text-white` (단독 사용)
> ✅ `dark:text-[#F0F0F0]`

**→ 상세 목록: [text-color-violations.md](./text-color-violations.md)**

### 사용자 페이지
| 파일 | 경로 | 위반 개수 |
|------|------|----------|
| AttendanceCalendar.tsx | `src/shared/components/` | 2곳 |
| PostRenderers.tsx | `src/domains/boards/components/post/postlist/components/shared/` | 1곳 |
| Power.tsx | `src/domains/livescore/components/football/match/tabs/` | 8곳 |
| NoticeBadge.tsx | `src/domains/boards/components/notice/` | 1곳 (확인 필요) |
...
### 1순위 (사용자 경험 직접 영향)
- [x] Blue Hover 위반 ✅ 완료 (사용자용)
- [x] 텍스트 링크 호버 위반 ✅ 완료
- [x] 다크모드 배경 위반 ✅ 완료 (사용자용 16개) → [dark-mode-violations.md](./dark-mode-violations.md)
- [x] 라이트모드 배경 위반 ✅ 완료 (사용자용 35개) → [light-mode-violations.md](./light-mode-violations.md)
- [x] 버튼 색상 위반 ✅ 완료 (사용자용 2개) → [button-color-violations.md](./button-color-violations.md)

### 2순위 (일관성)
- [x] 테두리 색상 위반 ✅ 완료 (사용자용 30개+) → [border-color-violations.md](./border-color-violations.md)
- [x] 라운드 크기 위반 ✅ 완료 (사용자용 8개) → [rounded-violations.md](./rounded-violations.md)
- [x] 텍스트 색상 위반 ⏭️ 스킵 (차이 미미, 브랜드 컬러 등 의도적 사용)

### 3순위 (Admin/Test)
- [ ] Admin 페이지들 - 추후 일괄 수정
- [ ] Test 페이지들 (tset/) - 무시 가능
