...
### 1.1 youtube-widget-client.tsx
- **경로**: `src/app/components/widgets/youtube-widget/youtube-widget-client.tsx`
- **라인 109**
```tsx
// Before
...
// After
<h3 className="... group-hover:text-gray-600 dark:group-hover:text-gray-300 ...">
```

### 1.2 BannerCarousel.tsx
- **경로**: `src/domains/widgets/components/banner-widget/BannerCarousel.tsx`
- **라인 53, 56, 62, 65** (좌우 화살표)
```tsx
// Before (라인 53)
hover:bg-blue-50 hover:border-blue-300

// After
hover:bg-[#EAEAEA] dark:hover:bg-[#333333] hover:border-gray-300

// Before (라인 56, 65)
group-hover:text-blue-600

// After
group-hover:text-gray-900 dark:group-hover:text-[#F0F0F0]
```
...
### 1.4 live-score-widget-client.tsx
- **경로**: `src/domains/widgets/components/live-score-widget-client.tsx`
- **라인 319, 324, 344, 359, 360, 364, 365**
```tsx
// Before
group-hover:text-blue-600
