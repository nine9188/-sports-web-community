...
export const PREDEFINED_PAGES: PredefinedPage[] = [
  ...
  { path: '/help/find-id', name: '아이디 찾기', defaultTitle: '아이디 찾기 - 4590 Football', defaultDescription: '아이디 찾기 페이지입니다.' },
  { path: '/help/find-password', name: '비밀번호 찾기', defaultTitle: '비밀번호 찾기 - 4590 Football', defaultDescription: '비밀번호 찾기 페이지입니다.' },
