...
const CARD_STYLES = {
  base: "bg-white dark:bg-[#1D1D1D] md:rounded-lg border border-black/7 dark:border-0 overflow-hidden hover:bg-[#EAEAEA] dark:hover:bg-[#333333] transition-colors group touch-manipulation",
  transform: {
...
export function MainCard({ item }: MainCardProps) {
  return (
    <Link
      href={item.url}
      className="block bg-white dark:bg-[#1D1D1D] md:rounded-lg border border-black/7 dark:border-0 overflow-hidden hover:bg-[#EAEAEA] dark:hover:bg-[#333333] transition-colors group touch-manipulation h-[304px]"
