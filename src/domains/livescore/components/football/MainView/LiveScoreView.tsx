                ...
                {[1, 2, 3].map((match, idx) => (
                  <div key={match} className={`h-12 px-4 flex items-center ${idx !== 2 ? 'border-b border-black/5 dark:border-white/10' : ''}`}>
                    ...
                    <div className="w-14 flex-shrink-0 flex items-center">
                      <div className="w-10 h-5 bg-[#EAEAEA] dark:bg-[#333333] rounded animate-pulse"></div>
                    </div>

                    {/* 홈팀 */}
                    <div className="flex-1 flex items-center justify-end gap-2 min-w-0">
                      <div className="h-3 w-20 bg-[#EAEAEA] dark:bg-[#333333] rounded animate-pulse"></div>
                      <div className="w-6 h-6 bg-[#EAEAEA] dark:bg-[#333333] rounded-full animate-pulse flex-shrink-0"></div>
                    </div>

                    {/* 스코어 */}
                    <div className="px-2 flex-shrink-0">
                      <div className="w-12 h-4 bg-[#EAEAEA] dark:bg-[#333333] rounded animate-pulse"></div>
                    </div>
