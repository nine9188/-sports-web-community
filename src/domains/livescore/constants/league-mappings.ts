...
export const LEAGUE_NAMES_MAP: Record<number, string> = {
  ...
  // 유럽 컵 대회
  [MAJOR_LEAGUE_IDS.CHAMPIONS_LEAGUE]: '챔피언스리그',
  [MAJOR_LEAGUE_IDS.EUROPA_LEAGUE]: '유로파리그',
  [MAJOR_LEAGUE_IDS.CONFERENCE_LEAGUE]: '컨퍼런스리그',
  [MAJOR_LEAGUE_IDS.UEFA_SUPER_CUP]: 'UEFA슈퍼컵',
