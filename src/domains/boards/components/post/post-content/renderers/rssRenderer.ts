    ...
    <div class="mb-6">
      ...
      <div class="flex justify-between items-center mb-4">
        <a href="${sourceUrl}" target="_blank" rel="noopener noreferrer"
          class="inline-flex items-center px-4 py-2 text-[13px] font-medium text-white bg-[#262626] dark:bg-[#3F3F3F] rounded-md hover:bg-[#3F3F3F] dark:hover:bg-[#4A4A4A] transition-colors">
