    ...
    return (
      <div className="hidden sm:block">
        ...
        <div className="flex border-b border-black/5 dark:border-white/10 bg-[#F5F5F5] dark:bg-[#262626]">
          {showBoard && (
            <div
              className="py-2 px-3 text-center text-[13px] font-medium text-gray-600 dark:text-gray-400"
              style={{ width: '120px' }}
            >
              게시판
            </div>
          )}
          <div className="py-2 px-4 text-center text-[13px] font-medium text-gray-600 dark:text-gray-400 flex-1">
            제목
          </div>
          <div
            className="py-2 px-3 text-center text-[13px] font-medium text-gray-600 dark:text-gray-400"
          ...
          <div
            className="py-2 px-1 text-center text-[13px] font-medium text-gray-600 dark:text-gray-400"
            style={{ width: '80px' }}
          >
            날짜
          </div>
