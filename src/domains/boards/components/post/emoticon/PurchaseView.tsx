          ...
          <>
            <div className="flex items-center gap-3 p-3 rounded-lg border border-black/5 dark:border-white/10 bg-[#F5F5F5] dark:bg-[#262626] mb-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-sm text-gray-900 dark:text-[#F0F0F0]">{pack.pack_name} 팩</p>
            ...
            <div className="bg-[#F5F5F5] dark:bg-[#262626] p-4 rounded-lg space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-semibold tabular-nums text-gray-900 dark:text-[#F0F0F0]">- {(pack.price || 0).toLocaleString()} P</span>
              </div>
              <div className="border-t border-black/5 dark:border-white/10 pt-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{affordable ? '남는 포인트' : '부족한 포인트'}</span>
