...
export default function HoverMenu({
  ...
  // 메뉴 UI 렌더링 (기존 HoverMenu 스타일로 변경)
  return (
    <div className="bg-white border rounded-lg shadow-sm mb-4">
      <div className="p-4 relative" ref={containerRef}>
        ...
        {isMobile && clickedMobileMenu && getChildBoards(clickedMobileMenu).length > 0 && (
          <div 
          ...
          >
            <div className="p-3">
              <div className="flex flex-col space-y-1">
                {getChildBoards(clickedMobileMenu)
        ...
        {/* 데스크톱 호버 메뉴 */}
        {!isMobile && hoveredBoard && getChildBoards(hoveredBoard).length > 0 && (
          <div
            ref={menuRef}
