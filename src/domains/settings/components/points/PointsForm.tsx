    ...
    <div>
      ...
      <div className="bg-white dark:bg-[#1D1D1D]">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
          <h3 className="text-base font-medium text-gray-900 dark:text-[#F0F0F0] mb-2 md:mb-0">보유 포인트</h3>
      ...
      <div className="p-0 mt-4">
        <h3 className="font-medium text-gray-900 dark:text-[#F0F0F0] mb-2">포인트 획득 방법</h3>
