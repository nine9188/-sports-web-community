...
const SearchModal = React.memo(function SearchModal({
  ...
  return ReactDOM.createPortal(
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-start justify-center pt-20 px-8">
      <div className="bg-white rounded-lg shadow-xl max-w-sm sm:max-w-md p-4 sm:p-6">
