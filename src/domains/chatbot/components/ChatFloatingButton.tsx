    ...
    <div className="fixed bottom-6 right-6 z-50">
      <Button
        ...
        className={cn(
          ...
          'hover:scale-110',
          'bg-[#262626] dark:bg-[#3F3F3F] hover:bg-[#3F3F3F] dark:hover:bg-[#4A4A4A]',
          'active:scale-95'
        )}
      ...
      >
        ...
        {/* Ripple effect */}
        {!isOpen && (
          <div className="absolute inset-0 rounded-full bg-gray-400 dark:bg-gray-500 animate-ping opacity-20" />
        )}
