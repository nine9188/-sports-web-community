  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      >
        ...
        {/* Hover tooltip */}
        {isHovered && !isOpen && (
          <div className="absolute bottom-full right-0 mb-2 px-3 py-1 bg-gray-800 text-white text-sm rounded-lg whitespace-nowrap animate-in fade-in-0 zoom-in-95 duration-200">
            고객센터 문의
