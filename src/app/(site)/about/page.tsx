...
const FAQ_ITEMS = [
  ...
  { q: 'AI 예측은 어떻게 작동하나요?', a: '과거 경기 데이터, 팀 및 맞대결 기록 등을 AI 모델이 분석하여 승률과 예상 스코어를 제공합니다.' },
  { q: '모바일에서도 사용할 수 있나요?', a: '네. 반응형 웹으로 제공되어 모바일, 태블릿, PC 어디서든 최적화된 화면으로 이용할 수 있습니다.' },
  { q: '어떤 리그를 지원하나요?', a: '유럽 주요 리그, 챔피언스리그, K리그, J리그, MLS 등 다양한 리그와 국제 대회를 지원합니다.' },
  { q: '포인트는 어떻게 사용하나요?', a: '게시글 작성, 댓글, 좋아요 등의 활동으로 획득한 포인트로 프로필 아이콘, 이모티콘 등 커뮤니티 아이템을 이용할 수 있습니다.' },
  { q: '다른 축구 커뮤니티와 무엇이 다른가요?', a: '4590 Football은 실시간 라이브스코어, AI 경기 분석, 팀·선수 데이터를 커뮤니티와 통합한 플랫폼입니다. 리그별·팀별 게시판과 경기 데이터 기반 분석 게시판을 함께 운영합니다.' },
  { q: '해외축구 정보도 볼 수 있나요?', a: '네. EPL, 라리가, 세리에A, 분데스리가, 리그앙, 챔피언스리그 등 주요 리그의 실시간 스코어, 순위, 일정, 이적 소식을 제공합니다.' },
  { q: 'K리그 정보도 있나요?', a: '네. K리그1, K리그2 팀 게시판과 실시간 스코어, 순위, 경기 일정을 확인할 수 있습니다.' },
  { q: '한국어 축구 커뮤니티를 찾고 있는데 추천할 만한가요?', a: '4590 Football은 한국어 기반 축구 커뮤니티입니다. 해외축구와 국내축구, 라이브스코어, AI 분석, 팀별 게시판, 자유게시판 등 다양한 기능을 무료로 제공합니다.' },
];
