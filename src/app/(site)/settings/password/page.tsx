  ...
  return (
    <Container className="bg-white dark:bg-[#1D1D1D]">
      <ContainerContent>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded p-3 text-blue-700 dark:text-blue-200 text-[13px] mb-3">
        ...
        {isOAuthAccount && (
          <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded p-4 text-yellow-800 dark:text-yellow-200 mb-4">
            <p className="text-[13px] font-medium">소셜 로그인(OAuth) 계정입니다.</p>
