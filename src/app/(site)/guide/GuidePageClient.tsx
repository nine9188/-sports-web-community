...
const LEVEL_2_ICON_URL = profileIconUrl('level-icons/level-2.png');
            ...
            <div className="flex items-center justify-between mb-1">
              <div className="flex items-center space-x-2">
                <div className="w-5 h-5 rounded-full overflow-hidden bg-[#F5F5F5] dark:bg-[#262626] flex-shrink-0">
                  <Image src={LEVEL_2_ICON_URL} alt="레벨 아이콘" width={20} height={20} className="w-full h-full object-contain" />
                </div>
            ...
            <div className="relative overflow-visible">
              ...
              <div className="flex items-center space-x-1 h-10 px-3 cursor-pointer">
                <div className="w-5 h-5 rounded-full overflow-hidden">
                  <Image src={LEVEL_2_ICON_URL} alt="프로필" width={20} height={20} className="w-full h-full object-cover" />
                </div>
...
function ProfileIconDemo({ images }: { images: GuideDemoImages }) {
  ...
  const levelIconUrl = LEVEL_2_ICON_URL;
