      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none text-[13px] leading-7 space-y-6
          ...
          <section>
            ...
            <h3 className="text-base font-medium text-gray-900 dark:text-[#F0F0F0] mt-4">4. 제3자 광고 서비스(구글 애드센스 등)의 쿠키 사용</h3>
            <p>
          ...
          <section>
            ...
            <div className="bg-[#F5F5F5] dark:bg-[#2D2D2D] p-4 rounded-lg mt-4">
              ...
              <ul className="list-none mt-2 space-y-1 text-gray-700 dark:text-gray-300">
                ...
                <li>이메일: <a href="mailto:support@4590fb.com" className="text-blue-600 dark:text-blue-400 hover:underline">support@4590fb.com</a></li>
