  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center mb-4">
        ...
        <div>
          <div className="text-sm font-medium text-gray-700">{displayIconName}</div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border overflow-hidden p-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
          <h3 className="text-base font-medium text-gray-900 mb-2 sm:mb-0">아이콘 선택</h3>
      ...
      <div className="p-0 mt-6">
        <h3 className="font-medium text-gray-900 mb-2">새로운 아이콘이 필요하신가요?</h3>
