...
import { signInWithKakao, signInWithGoogle, signInWithDiscord, signInWithApple } from '@/domains/auth/actions';
    ...
    <div className="flex flex-col justify-center items-center min-h-[calc(100vh-120px)]">
      <div className="flex w-full max-w-md lg:max-w-full">
        ...
        <div className="flex justify-center items-center gap-4 mb-6">
          ...
          <button type="button" onClick={() => handleSocialLogin('apple')} disabled={isLoading} className="w-12 h-12 rounded-full bg-black dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-100 flex items-center justify-center transition-colors disabled:opacity-50 disabled:cursor-not-allowed" title="Apple 로그인">
