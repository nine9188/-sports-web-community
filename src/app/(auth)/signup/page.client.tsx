    ...
    <div className="flex flex-col justify-center items-center min-h-[calc(100vh-120px)]">
      <div className="flex w-full max-w-md lg:max-w-full">
        ...
        <div className="flex justify-center items-center gap-4 mb-6">
          <button type="button" onClick={handleKakaoLogin} disabled={isLoading} className="w-12 h-12 rounded-full bg-[#FEE500] hover:bg-[#FFEB00] flex items-center justify-center transition-colors disabled:opacity-50 disabled:cursor-not-allowed" title="카카오 로그인">
          ...
          <button type="button" disabled className="w-12 h-12 rounded-full bg-white dark:bg-[#2D2D2D] border border-gray-200 dark:border-white/15 flex items-center justify-center transition-colors opacity-50 cursor-not-allowed" title="구글 로그인 (준비 중)">
          ...
          <button type="button" disabled className="w-12 h-12 rounded-full bg-[#5865F2] flex items-center justify-center transition-colors opacity-50 cursor-not-allowed" title="디스코드 로그인 (준비 중)">
          ...
          <button type="button" disabled className="w-12 h-12 rounded-full bg-black dark:bg-white flex items-center justify-center transition-colors opacity-50 cursor-not-allowed" title="Apple 로그인 (준비 중)">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="white" className="dark:fill-black"><path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.4C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/></svg>
          </button>
        </div>
