    ...
    <div className="w-full lg:w-1/2 max-w-md lg:max-w-none md:bg-white md:dark:bg-[#2D2D2D] md:rounded-lg lg:rounded-l-none md:shadow-lg md:border md:border-black/10 md:dark:border-white/10 lg:border-l-0 md:p-8 lg:p-14 flex flex-col justify-center">
      ...
      <div className="flex justify-center items-center gap-4 mb-6">
        ...
        <button
          ...
          disabled={loading}
          className="w-12 h-12 rounded-full bg-[#03C75A] hover:bg-[#02b351] flex items-center justify-center transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          title="네이버 로그인"
        >
          <svg width="18" height="18" viewBox="0 0 20 20" fill="white">
            <path d="M13.5 10.6L6.3 0H0v20h6.5V9.4L13.7 20H20V0h-6.5z"/>
          </svg>
        </button>
