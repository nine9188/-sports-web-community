  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-[calc(100vh-120px)] px-4">
      <div className="w-full max-w-2xl">
        ...
        {/* 헤더 */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-left mb-2">개인정보처리방침</h1>
          <p className="text-gray-600 text-left">회원의 개인정보 보호를 위한 방침을 안내합니다.</p>
          <p className="mt-2 text-xs text-gray-500">
            참고: 본 방침은 외부 정책 문서를 기반으로 작성되었습니다. 자세한 내용은
            {' '}<Link href="https://policy.op.gg/view/6593c6e4-d645-48a1-8513-1760bc9d6a5d" target="_blank" className="underline hover:text-slate-800">OP.GG 개인정보처리방침</Link>을 참고하세요.
          </p>
        </div>
