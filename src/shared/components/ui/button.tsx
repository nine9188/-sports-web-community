...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-[13px] font-medium transition-colors outline-none focus:outline-none focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        primary: "bg-brand-primary dark:bg-brand-primary-dark text-white hover:bg-brand-hover dark:hover:bg-brand-hover-dark",
        destructive:
