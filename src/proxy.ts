...
const DISALLOWED_BOT_PATTERN =
  /(semrushbot|mj12bot|claudebot|claude-searchbot|gptbot|chatgpt-user|oai-searchbot|ahrefsbot|dotbot|rogerbot|petalbot|megaindex|blexbot|ccbot|amazonbot|perplexitybot|perplexity-user|google-extended|applebot-extended|bytespider|byte-spider|dataforseabot|dataforseobot|seranking|barkrowler|anthropic-ai|cohere-ai|diffbot|img2dataset|omgili|webzio-extended|scrapy|yandexbot|yandex)/i
